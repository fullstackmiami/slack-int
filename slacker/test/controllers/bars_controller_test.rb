...
class BarsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create bar" do
    assert_difference('Bar.count') do
      post bars_url, params: { bar: { address: @bar.address, description: @bar.description, food: @bar.food, name: @bar.name, photo: @bar.photo } }
    end
  ...
  test "should update bar" do
    patch bar_url(@bar), params: { bar: { address: @bar.address, description: @bar.description, food: @bar.food, name: @bar.name, photo: @bar.photo } }
